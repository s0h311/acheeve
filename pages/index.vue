<template>
  <div class="grid grid-rows-[45% 45% 8%] h-screen responsive-w mx-auto">
    ...
    <div class="w-full hideScrollbar overflow-y-scroll overflow-x-hidden p-5">
      <HabitListing
    ...
    <div class="w-full">
      ...
      <AddEntryMenu
        class="w-screen md:w-full md:left-auto left-0 mb-2"
        v-if="addEntryMenuActive"
