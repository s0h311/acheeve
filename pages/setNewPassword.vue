<template>
  <div class="grid place-items-center w-full my-auto">
    ...
    <InputField class="mb-6" name="password" :label="$t('input_new_password')" placeholder="*******" type="password" :is-error="errorMessage" @change-input="onchange" />

    <InputField name="passwordConfirm" :label="$t('input_confirm_new_password')" placeholder="*******" type="password" :is-error="errorMessage" @change-input="onchange" />
